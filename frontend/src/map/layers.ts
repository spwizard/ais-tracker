...
// Dead reckoning lives in ./deadReckon (pure module — keeps unit tests free of
// this file's browser-only imports). Re-exported for the other layer modules.
export { deadReckon, DR_SCRATCH } from "./deadReckon";
